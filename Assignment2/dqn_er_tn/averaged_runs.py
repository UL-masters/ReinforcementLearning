...
PATTERN = "Assignment2/dqn_er_tn/dqn_er_tn_results_*.csv"          # change this to match your filenames
OUTPUT  = "Assignment2/dqn_er_tn/average_dqn_er_tn_results.csv"        # output file name
