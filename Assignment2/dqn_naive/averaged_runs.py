...
PATTERN = "Assignment2/dqn_naive/dqn_naive_results_*.csv"          # change this to match your filenames
OUTPUT  = "Assignment2/dqn_naive/average_dqn_naive_results.csv"        # output file name
